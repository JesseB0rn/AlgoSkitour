...
\listoffigures
\skiplines{2}
Alle Abbildungen ohne Kurzverweis in der Beschriftung stammen aus eigener Hand. Die Hintergrundkarten stammen wo nicht anders erwähnt aus der <<LK-Winter>> von swisstopo. Die SAC-Routen stammen aus den Tourenführern \cite{mmzentralch} und \cite{twslstgallappzll}.
\clearpage
